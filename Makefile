...
help:
	...
	@echo "  make merge              Fetch upstream beta, merge into beta, create immutable tag, update latest tag"
	@echo "  make release            Release current beta without merging upstream"
	@echo ""
	@echo "Options:"
	...
	@echo "  TARGET_BRANCH=x         Override target branch (default: beta)"
